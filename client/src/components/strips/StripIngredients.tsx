                    ...
                    >
                        ...
                        >
                            ...
                            <div className="block mb-[40px]">
                                <h2
                                    className="text-[clamp(48px,_4.5vw,_120px)] leading-[1] font-normal text-black"
                                    style={{
                                    textShadow: `
                                        0 6px 0 #fff,  0 -6px 0 #fff,
                                        6px 0 0 #fff,  -6px 0 0 #fff,
                            ...
                            <div className="max-h-[70vh] overflow-y-auto text-gray-800 text-[16px] leading-relaxed">
                                {children ? (
                                    children
                                ) : (
                                    <>
                                        <ul className="flex flex-col gap-[10px]">
                                            <li className="flex gap-[12px]">
                                                <svg className="mt-[8px]" width="11" height="10" viewBox="0 0 22 20" fill="none" xmlns="http://www.w3.org/2000/svg">
