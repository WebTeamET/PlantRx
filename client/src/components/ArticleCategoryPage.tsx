...
import { ArrowRight, Clock, User, BookOpen, Split } from "lucide-react";
...
export function ArticleCategoryPage({ category, relatedCategories = [] }: ArticleCategoryPageProps) {
  ...
  return (
    <div className="min-h-screen bg-white dark:bg-gray-950">
      ...
      {/* Hero Section */}
      <section className={`relative py-16 sm:py-24 bg-[linear-gradient(to_right,#385127_0%,#c2a058_51%,#385127_100%)] ${category.color}`}>
        ...
        <div className="relative max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <motion.div variants={slideUpVariants as any}
            initial="hidden"
            whileInView="visible"
            viewport={{ once: true, amount: 0 }} className="inline-flex items-center justify-center w-20 h-20 rounded-3xl bg-white/20 backdrop-blur-sm mb-6 border border-white/30">
          ...
          <motion.p variants={slideUpVariants as any}
            initial="hidden"
            whileInView="visible"
            viewport={{ once: true, amount: 0 }} className="text-lg sm:text-xl text-white/90 max-w-3xl mx-auto leading-relaxed">
          ...
          <motion.div variants={slideUpVariants as any}
            initial="hidden"
            whileInView="visible"
            viewport={{ once: true, amount: 0 }} className="mt-8 inline-flex items-center gap-2 px-4 py-2 bg-white/20 backdrop-blur-sm rounded-full text-white/90 text-sm font-medium">
      ...
      {/* Articles Grid */}
      <section className="py-12 sm:py-16 bg-green/10 dark:bg-gray-900">
          ...
          {isLoading ? (
            ...
            <div className="text-center py-16">
              <motion.div variants={slideUpVariants as any}
                initial="hidden"
                whileInView="visible"
                viewport={{ once: true, amount: 0 }} className={`inline-flex items-center justify-center w-16 h-16 rounded-2xl  bg-green ${category.color} mb-6`}>
              ...
              <motion.p variants={slideUpVariants as any}
                initial="hidden"
                whileInView="visible"
                viewport={{ once: true, amount: 0 }} className="text-gray-600 dark:text-gray-400 max-w-md mx-auto mb-6">
              ...
              <motion.div variants={slideUpVariants as any}
                ...
                <Link href="/articles">
                  <Button variant="outline" className={`border-2 border-green !text-green hover:bg-green hover:!text-white ${category.accentColor}`}>
      ...
      {/* Related Categories */}
      {
        relatedCategories.length > 0 && (
          <section className="py-12 sm:py-16 bg-green/10 dark:bg-gray-950">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
              <h2 className="text-2xl font-bold text-gray-900 dark:text-white mb-8 text-center">
                <SplitText text="Explore More Topics" />
              </h2>
                ...
                {relatedCategories.map((cat) => (
                  <motion.div variants={slideUpVariants as any}
                    ...
                    <Link key={cat.href} href={cat.href}>
                      <Button
                        variant="outline"
                        className={`${cat.color} border-green text-green hover:bg-green hover:text-white`}
      ...
      {/* CTA Section */}
      <section className={`py-12 sm:py-16 bg-[linear-gradient(to_right,#385127_0%,#c2a058_51%,#385127_100%)] ${category.color}`}>
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="text-2xl sm:text-3xl font-bold text-white mb-4">
            <SplitText text="Explore All Health Topics" />
          </h2>
          <motion.p variants={slideUpVariants as any}
            initial="hidden"
            whileInView="visible"
            viewport={{ once: true, amount: 0 }} className="text-white/80 mb-6 max-w-xl mx-auto">
