...
import {
  Copyright, FileWarning, Send, Shield, AlertTriangle, Scale, Mail, FileText,
  MessageCircle, CheckCircle, XCircle, Clock, Gavel
} from "lucide-react";
    ...
    <div className="min-h-screen bg-gold/5 dark:bg-gray-950">
      ...
      <section className="relative pt-24 pb-16">
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 relative">
          ...
          <motion.div className="text-center mt-8" variants={slideUpVariants as any}
            initial="hidden"
            whileInView="visible"
      ...
      <section className="py-16 bg-gold/5 dark:bg-gray-950">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <motion.div className="mb-8" variants={slideUpVariants as any}
            initial="hidden"
            whileInView="visible"
            viewport={{ once: true, amount: 0.2 }}>
            <Card className="bg-white dark:bg-gray-900 border border-gold/20 dark:border-gold/10 shadow-lg overflow-hidden">
              <div className="flex items-center gap-4 !p-4 sm:!p-6 border-b border-gold/10 dark:border-gold/5">
                <div className="w-12 h-12 bg-gold/20 dark:bg-red-900/30 rounded-xl flex items-center justify-center">
                  <FileWarning className="w-6 h-6 text-gold dark:text-red-400" />
                </div>
                <div>
              ...
              <CardContent className="!p-4 sm:!p-6">
                ...
                <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-4">
                  {[
                    ...
                    <div key={item.num} className="bg-gold/5 dark:bg-gray-800 rounded-xl p-4 border border-gold/20 dark:border-gold/10">
                      <div className="flex items-start gap-3">
                        <span className="w-7 h-7 rounded-full bg-green flex items-center justify-center text-white text-sm font-bold flex-shrink-0">{item.num}</span>
                        <div>
              ...
              <Card className="bg-white dark:bg-gray-900 border border-gold/20 dark:border-gold/10 shadow-lg overflow-hidden h-full">
                <div className="flex items-center gap-4 p-6 border-b border-gold/10 dark:border-gold/5">
                  <div className="w-12 h-12 bg-gold/20 dark:bg-gold/10 rounded-xl flex items-center justify-center">
                    <Send className="w-6 h-6 text-gold dark:text-gold" />
                  </div>
                ...
                <CardContent className="!p-4 sm:!p-6">
                  ...
                  <div className="bg-gold/10 dark:bg-gray-800 rounded-xl p-5 border border-gold/20 dark:border-gold/10 space-y-3">
              ...
              <CardContent className="!p-4 sm:!p-6">
                ...
                <div className="grid md:grid-cols-2 gap-4 mb-6">
                  {[
                    ...
                    <div key={i} className="flex items-start gap-3 p-4 bg-gold/10 dark:bg-gray-800 rounded-lg border border-gold/20 dark:border-gold/10">
                ...
                <div className="bg-gold/10 dark:bg-gray-800 border-l-4 border-gold p-4 rounded-r-lg">
          ...
          >
            ...
            <motion.div variants={slideUpVariants as any}>
              <Card className="bg-white dark:bg-gray-900 border border-gold/20 dark:border-gold/10 shadow-lg overflow-hidden h-full">
                <div className="flex items-center gap-4 p-6 border-b border-gold/10 dark:border-gold/5">
                  <div className="w-12 h-12 bg-gold/20 dark:bg-red-900/30 rounded-xl flex items-center justify-center">
                    <AlertTriangle className="w-6 h-6 text-gold dark:text-red-400" />
                  </div>
                  <h2 className="text-xl font-bold text-gray-900 dark:text-white">Repeat Infringer Policy</h2>
                </div>
                <CardContent className="!p-4 sm:!p-6">
                  <div className="bg-gold/10 dark:bg-gray-800 border-l-4 border-gold p-4 rounded-r-lg mb-4">
            ...
            <motion.div variants={slideUpVariants as any}>
              <Card className="bg-white dark:bg-gray-900 border border-gold/20 dark:border-gold/10 shadow-lg overflow-hidden h-full">
                <div className="flex items-center gap-4 p-6 border-b border-gold/10 dark:border-gold/5">
                  <div className="w-12 h-12 bg-gold/20 dark:bg-gold/10 rounded-xl flex items-center justify-center">
                    <Gavel className="w-6 h-6 text-gold dark:text-gold" />
                  </div>
                  ...
                  <div className="space-y-3">
                    {[
                      ...
                      <div key={i} className="flex items-center gap-3 p-3 bg-gold/10 dark:bg-gray-800 rounded-lg border border-gold/20 dark:border-gold/10">
                        <CheckCircle className="w-5 h-5 text-gold dark:text-gold flex-shrink-0" />
                        <span className="text-gray-900 dark:text-white text-sm">{item}</span>
                      </div>
                    ))}
                  </div>
