    ...
    <>
      ...
      >
        <div className="max-w-2xl w-full rounded-lg shadow-xl flex items-center justify-between md:gap-10 gap-3 bg-white md:px-5 px-3 md:py-2 py-3">
          ...
          <button
            className={`ctm-button md:min-w-[180px] max-md:text-xs max-md:leading-[15px] max-md:px-3 max-md:py-1 max-md:min-w-full max-md:min-h-[34px] tracking-[0.3px] btn-green  ${loading ? "loading" : ""}`}
            onClick={handleClick}
            disabled={loading}
          >
            Add to cart
