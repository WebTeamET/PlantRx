        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                        ...
                        {tier.features.map((feature, index) => (
                          <li key={index} className="flex items-start gap-2 md:gap-3">
                            <div className="flex-shrink-0 mt-0.5 md:mt-1">
                              <div className="w-4 h-4 md:w-5 md:h-5 rounded-full bg-green/10 dark:bg-gold/10 flex items-center justify-center border border-gold/20">
                                <Check className="w-2.5 h-2.5 md:w-3.5 md:h-3.5 text-green dark:text-gold font-bold" />
                              </div>
                            </div>
          ...
          <div className="max-w-4xl mx-auto mb-12 sm:mb-16">
            ...
            <StaggerContainer className="w-full space-y-3 sm:space-y-4">
              {[
                { value: "item-1", q: "What's the difference between Bronze, Silver, and Gold plans?", a: <><p className="text-left text-sm sm:text-base text-gray-600 dark:text-gray-300 py-2"><strong className="text-gray-900 dark:text-gray-300">Bronze (Free):</strong> Perfect for beginners! Get full access to our Remedy Library with 131+ verified plant-based remedies, browse our Wellness Shop, and join our Community Lounge.</p><p className="text-left text-sm sm:text-base text-gray-600 dark:text-gray-300 py-2"><strong className="text-gray-900 dark:text-gray-300">Silver (£6.99/month):</strong> Take your wellness to the next level with the Interactive Muscle Trainer for targeted workouts, premium community features, and priority access to expert consultations.</p><p class="text-left text-sm sm:text-base text-gray-600 dark:text-gray-300 py-2"><strong className="text-gray-900 dark:text-gray-300">Gold (£12.99/month):</strong> Unlock everything! Get AI-powered tools like the Wellness Blueprint Designer, Smart Remedy Builder, and AI Symptom Finder for personalized health insights and comprehensive wellness planning.</p></> },
                { value: "item-2", q: "Can I upgrade or downgrade my plan anytime?", a: <p className="text-left text-sm sm:text-base text-gray-600 dark:text-gray-300 py-2">Absolutely! You can upgrade or downgrade your membership at any time. When you upgrade, you'll gain immediate access to new features. If you downgrade, changes take effect at the end of your current billing period, so you won't lose any paid time. Simply visit your Dashboard and manage your subscription settings.</p> },
                { value: "item-3", q: "How do I cancel my subscription?", a: <><p className="text-left text-sm sm:text-base text-gray-600 dark:text-gray-300 py-2">Canceling is simple and hassle-free. Go to your Dashboard, click on "Subscription Settings," and select "Cancel Subscription." You'll retain access to all premium features until the end of your current billing period.</p><p className="italic text-xs sm:text-sm">We're sorry to see you go, but there are no cancellation fees or penalties. You can always rejoin anytime!</p></> },
                { value: "item-5", q: "Do you offer refunds?", a: <><p className="text-left text-sm sm:text-base text-gray-600 dark:text-gray-300 py-2">We want you to be 100% satisfied with PlantRx. If you're not happy with your paid membership within the first 7 days, contact our support team at <a href="mailto:support@plantrxapp.com" className="text-green dark:text-gold hover:underline">support@plantrxapp.com</a> for a full refund, no questions asked.</p><p className="text-xs sm:text-sm">After 7 days, refunds are handled on a case-by-case basis. See our <a href="/refunds" className="text-green dark:text-gold hover:underline">Refund Policy</a> for full details.</p></> },
                { value: "item-6", q: "Is there a free trial for Silver or Gold plans?", a: <><p className="text-left text-sm sm:text-base text-gray-600 dark:text-gray-300 py-2"><strong className="text-green dark:text-gold">Yes!</strong> We offer a <strong className="text-gray-900 dark:text-gray-300">free 24-hour Gold trial</strong> so you can experience all premium features before committing. No credit card required - just sign up and activate your trial to unlock AI-powered tools like the Wellness Blueprint Designer, Smart Remedy Builder, and AI Symptom Finder.</p><p className="text-left text-sm sm:text-base text-gray-600 dark:text-gray-300 py-2">After your trial ends, you can upgrade to Gold or Silver, or continue with our Bronze (Free) plan which includes 131+ remedies and community access.</p></> },
                { value: "item-8", q: "What happens to my data if I cancel?", a: <><p className="text-left text-sm sm:text-base text-gray-600 dark:text-gray-300 py-2">Your account remains active with all your saved remedies, preferences, and chat history preserved. You'll be downgraded to Bronze (Free) tier, which means you'll lose access to premium features like AI tools and advanced workouts, but your core account data stays intact.</p><p className="text-left text-sm sm:text-base text-gray-600 dark:text-gray-300 py-2">You can reactivate your subscription anytime to regain full access to premium features.</p></> },
                { value: "item-9", q: "Do I need a credit card for the Bronze (Free) plan?", a: <p className="text-left text-sm sm:text-base text-gray-600 dark:text-gray-300 py-2">No! The Bronze plan is completely free with no credit card required. Simply create an account and you'll have instant access to 131+ verified remedies, our Wellness Shop, and Community Lounge. No payment information needed unless you decide to upgrade to Silver or Gold.</p> },
                { value: "item-10", q: "Is my payment information secure?", a: <><p className="text-left text-sm sm:text-base text-gray-600 dark:text-gray-300 py-2">Absolutely! We use Stripe, one of the world's most trusted payment processors, to handle all transactions. Your payment information is encrypted with bank-level security and is never stored on our servers.</p><p className="text-left font-semibold text-sm sm:text-base text-gray-900 dark:text-gray-300  flex items-center gap-2 mt-3"><Shield className="w-4 h-4 text-green dark:text-green" /><span>PCI-DSS compliant • SSL encrypted • GDPR compliant</span></p></> },
              ].map((faq) => (
                <StaggerItem key={faq.value}>
                  ...
                  >
                    <Accordion type="single" collapsible className="w-full">
                      ...
                      >
                        <AccordionTrigger className="text-left font-semibold text-sm sm:text-base text-gray-900 dark:text-white hover:text-green dark:hover:text-gold py-4 sm:py-5">
                          {faq.q}
                        </AccordionTrigger>
