...
import { Leaf, Award, Users, Globe, BookOpen, Microscope,Sparkles, ChevronRight,ArrowRight, ArrowLeft, CheckCircle, ChevronDown, Shield, Zap, Target, Download, Heart } from "lucide-react";
                        ...
                        <Card className="bg-white dark:bg-gray-900 border-gold dark:border-gray-700 overflow-hidden shadow-sm hover:shadow-xl hover:-translate-y-2 transition-all duration-300 h-full">
                          ...
                          <CardContent className="p-6 sm:p-8">
                            <div className="flex items-center gap-4 lg:mt-6 mb-4">
                              ...
                              <div>
                                <h2 className="text-lg sm:text-xl font-bold text-gray-900 dark:text-white">Zayan Beg</h2>
                                <p className="text-sm text-gray-500 dark:text-gray-400">Founder & CEO, PlantRx</p>
