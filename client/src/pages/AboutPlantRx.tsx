...
const features = [
  {
    ...
    gradient: "bg-[linear-gradient(to_right,#385127_0%,#c2a058_51%,#385127_100%)] bg-[length:200%_auto] hover:bg-[position:right_center]",
    bgLight: "bg-gold",
    bgDark: "bg-[linear-gradient(to_right,#385127_0%,#c2a058_51%,#385127_100%)] bg-[length:200%_auto] hover:bg-[position:right_center]",
      ...
      <main className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12 lg:py-20 relative z-10">
        ...
        <FadeInSection delay={0.1} className="text-center mb-16 sm:mb-20 relative">
          <motion.div variants={slideUpVariants as any}
            ...
            whileInView="visible"
            viewport={{ once: true, amount: 0.4 }}>
            <div className="w-20 h-20 sm:w-24 sm:h-24 mx-auto mb-6 bg-green rounded-2xl flex items-center justify-center shadow-xl shadow-green-500/20">
            ...
            <FadeInSection key={feature.title} delay={i * 0.08}>
              <Card className="bg-white dark:bg-gray-900 border-gray-200 dark:border-gray-700 overflow-hidden shadow-sm hover:shadow-xl hover:-translate-y-2 transition-all duration-300 h-full">
                ...
                <CardContent className="p-6 sm:p-8">
                  ...
                  <p className="text-lg text- dark:text-gray-300 leading-relaxed">
                    {feature.description}
                  </p>
                </CardContent>
              </Card>
          ...
          <Card className="bg-white dark:bg-gray-900 border-gray-200 dark:border-gray-700 overflow-hidden shadow-lg">
            ...
            <CardContent className="p-6 sm:p-8 lg:p-10">
              <div className="flex items-center gap-4 mb-8">
                <div className="w-12 h-12 sm:w-14 sm:h-14 bg-gold dark:bg-green-900/30 rounded-xl flex items-center justify-center flex-shrink-0 shadow-sm">
