...
export default function SmartTools() {
  ...
  const linkCardClassName =
    "!border-gold group hover:shadow-xl transition-all duration-300 luxury-glass luxury-border rounded-xl cursor-pointer overflow-hidden h-full min-h-[44px]";
      ...
      <UpgradeInterstitial feature={Feature.AI_SYMPTOM_FINDER}>
        ...
        <div className="page-content">
          ...
          <div className="text-center mb-6 sm:mb-10 lg:mb-16">
            ...
            <h1 className="text-xl sm:text-2xl lg:text-4xl luxury-heading text-black dark:text-white mb-3 sm:mb-4 lg:mb-6">
              <SplitText text="Smart Tools" />
            </h1>
            <motion.p variants={slideUpVariants as any} initial="hidden" whileInView="visible" viewport={{ once: true, amount: 0.2 }} className="text-sm sm:text-base lg:text-lg text-gray-600 dark:text-gray-300 max-w-xs sm:max-w-2xl lg:max-w-3xl mx-auto luxury-body leading-relaxed">
              Advanced symptom analysis tools to help you find the perfect natural solutions for your health concerns
            </motion.p>
          </div>

          <motion.div variants={slideUpVariants as any} initial="hidden" whileInView="visible" viewport={{ once: true, amount: 0.2 }} className="w-full space-y-6 sm:space-y-8 lg:space-y-12">
            {/* AI Health Chat */}
          ...
          <div className="w-full max-w-5xl mx-auto mt-8 sm:mt-12 lg:mt-16">
            <h2 className="text-xl sm:text-2xl lg:text-3xl font-bold text-black dark:text-white text-center mb-2 sm:mb-4 flex items-center justify-center gap-2">
              <div className="w-2 h-2 sm:w-3 sm:h-3 bg-[linear-gradient(to_right,#385127_0%,#c2a058_51%,#385127_100%)] bg-[length:200%_auto] rounded-full animate-pulse"></div>
              <SplitText text="Trending This Week"></SplitText>
              <div className="w-2 h-2 sm:w-3 sm:h-3 bg-[linear-gradient(to_right,#385127_0%,#c2a058_51%,#385127_100%)] bg-[length:200%_auto] rounded-full animate-pulse"></div>
            </h2>
            <motion.p variants={slideUpVariants as any} initial="hidden" whileInView="visible" viewport={{ once: true, amount: 0.2 }} className="text-gold dark:text-orange-400 font-medium text-center mb-4 sm:mb-6 lg:mb-8 text-sm sm:text-base lg:text-lg">What's hot in natural health this week</motion.p>

            <motion.div variants={containerVariants as any}
              initial="hidden"
              whileInView="visible"
              viewport={{ once: true, amount: 0.2 }} className="grid grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4 lg:gap-6">
              <motion.div variants={slideUpVariants as any}>
                <Link href="/blog/glp1-agonists-vs-natural-weight-loss-plant-alternatives">
                  <Card className={linkCardClassName}>
                    <CardContent className="p-4 sm:p-5 lg:p-6 text-center h-full flex flex-col justify-between">
                      <div>
                        <div className="w-10 h-10 sm:w-12 sm:h-12 lg:w-14 lg:h-14 bg-gold/50 rounded-xl mx-auto mb-3 sm:mb-4 flex items-center justify-center text-lg sm:text-xl lg:text-2xl shadow-lg group-hover:scale-110 transition-transform">
                          🧬
                        </div>
                        <h3 className="font-bold text-black dark:text-white group-hover:text-gold dark:group-hover:text-emerald-400 transition-colors mb-2 text-sm sm:text-base lg:text-lg">
                          GLP-1 Alternatives
                        </h3>
                      ...
                      <div className="w-10 sm:w-12 h-0.5 bg-gold rounded-full mx-auto mt-3 opacity-0 group-hover:opacity-100 transition-opacity"></div>
                    </CardContent>
                  </Card>
                </Link>
              </motion.div>
        ...
        <div className="bg-gradient-to-br from-gold/50 via-gold/50 to-gold-50 dark:from-emerald-900/10 dark:via-teal-900/10 dark:to-cyan-900/10 py-8 sm:py-12 dark:from-emerald-900/10 dark:via-teal-900/10 dark:to-cyan-900/10 py-6 sm:py-10 lg:py-16">
            ...
            <Collapsible>
              ...
              <CollapsibleContent className="mt-4 sm:mt-6">
                <div className="prose prose-sm sm:prose-base lg:prose-lg max-w-none dark:prose-invert p-4 sm:p-5 lg:p-6 bg-white dark:bg-gray-800/50 rounded-xl sm:rounded-2xl">
                  ...
                  <h3 className="text-lg sm:text-xl lg:text-2xl font-bold text-black dark:text-white mb-3 sm:mb-4 mt-6 sm:mt-8">How AI Symptom Analysis Works</h3>
                  ...
                  <h3 className="text-lg sm:text-xl lg:text-2xl font-bold text-black dark:text-white mb-3 sm:mb-4 mt-6 sm:mt-8">Benefits of AI-Powered Remedy Matching</h3>
                  ...
                  <h3 className="text-lg sm:text-xl lg:text-2xl font-bold text-black dark:text-white mb-3 sm:mb-4 mt-6 sm:mt-8">How to Use Smart Tools Effectively</h3>
                  ...
                  <h3 className="text-lg sm:text-xl lg:text-2xl font-bold text-black dark:text-white mb-3 sm:mb-4 mt-6 sm:mt-8">The Science Behind AI Health Intelligence</h3>
                  ...
                  <h3 className="text-lg sm:text-xl lg:text-2xl font-bold text-black dark:text-white mb-3 sm:mb-4 mt-6 sm:mt-8">Privacy, Security & Data Protection</h3>
                  ...
                  <h3 className="text-lg sm:text-xl lg:text-2xl font-bold text-black dark:text-white mb-3 sm:mb-4 mt-6 sm:mt-8">When to Use AI Tools vs Seeing a Practitioner</h3>
