          ...
          <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 relative">
            ...
            <div className="text-center mt-4 sm:mt-6 lg:mt-8">
              ...
              <motion.div
                ...
                viewport={{ once: true, amount: 0.2 }}
              >
                <p className="text-xs sm:text-sm text-white/70 mt-2 sm:mt-3 lg:mt-4">
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 pb-6 sm:pb-10 lg:pb-20">
        ...
        <div className="grid lg:grid-cols-3 gap-3 sm:gap-4 lg:gap-8">
          ...
          <div className="lg:col-span-2 space-y-4 sm:space-y-6 lg:space-y-10">
            ...
            <section className="bg-white dark:bg-gray-800 rounded-xl sm:rounded-2xl p-4 sm:p-6 lg:p-8 shadow-sm border border-gold/20 dark:border-gold/10">
              <div className="flex items-center gap-2 sm:gap-3 mb-4 sm:mb-6">
                <div className="w-8 h-8 sm:w-10 sm:h-10 rounded-lg bg-green/10 dark:bg-green/20 flex items-center justify-center flex-shrink-0">
                  <User className="w-4 h-4 sm:w-5 sm:h-5 text-green dark:text-green/80" />
                </div>
              ...
              <div className="bg-gold/5 dark:bg-gold/5 rounded-lg sm:rounded-xl p-3 sm:p-4 lg:p-5 mt-4 sm:mt-6 border border-gold/20">
                <div className="grid sm:grid-cols-2 gap-2 sm:gap-3 lg:gap-4 text-sm sm:text-base text-gray-700 dark:text-gray-300">
                  <div>
                    ...
                    <p className="text-gray-600 text-xl">PlantRx Ltd</p>
                  </div>
                  <div>
                    <span className="font-semibold text-gray-900 dark:text-white">Location:</span>
                    <p className="text-gray-600 text-xl">London, United Kingdom</p>
                  </div>
                  <div className="sm:col-span-2">
                    <span className="font-semibold text-gray-900 dark:text-white">Contact Email:</span>
                    <p className="text-gray-600 text-xl">support@plantrxapp.com</p>
                  </div>
                </div>
              </div>
            </section>
            ...
            <section className="bg-white dark:bg-gray-800 rounded-xl sm:rounded-2xl p-4 sm:p-6 lg:p-8 shadow-sm border border-gold/20 dark:border-gold/10">
              ...
              <div className="space-y-4 sm:space-y-6">
                <div className="bg-gold/10 dark:bg-gold/5 rounded-lg sm:rounded-xl p-3 sm:p-4 lg:p-6 border border-gold/20">
                ...
                <div className="bg-green/5 dark:bg-green/5 rounded-lg sm:rounded-xl p-3 sm:p-4 lg:p-6 border border-green/20">
                  ...
                  <div className="space-y-2 sm:space-y-3 text-xs sm:text-sm lg:text-base text-gray-700 dark:text-gray-300">
                    <div className="flex flex-col sm:flex-row gap-1 sm:gap-3">
                      <span className="font-semibold text-green min-w-fit">Usage:</span>
                      <span>Pages visited, features used, time spent on site, interaction patterns</span>
                    </div>
                    <div className="flex flex-col sm:flex-row gap-1 sm:gap-3">
                      <span className="font-semibold text-green min-w-fit">Device:</span>
                      <span>IP address, browser type, operating system, device identifiers</span>
                    </div>
                    <div className="flex flex-col sm:flex-row gap-1 sm:gap-3">
                      <span className="font-semibold text-green min-w-fit">Location:</span>
                      <span>Approximate geographic location based on IP address</span>
                    </div>
                    <div className="flex flex-col sm:flex-row gap-1 sm:gap-3">
                      <span className="font-semibold text-green min-w-fit">Cookies:</span>
            ...
            <section className="bg-white dark:bg-gray-800 rounded-xl sm:rounded-2xl p-4 sm:p-6 lg:p-8 shadow-sm border border-gold/20 dark:border-gold/10">
              <div className="flex items-center gap-2 sm:gap-3 mb-4 sm:mb-6">
                <div className="w-8 h-8 sm:w-10 sm:h-10 rounded-lg bg-green/10 dark:bg-green/20 flex items-center justify-center flex-shrink-0">
                  <Eye className="w-4 h-4 sm:w-5 sm:h-5 text-green dark:text-green/80" />
                </div>
              ...
              <div className="grid sm:grid-cols-2 gap-2 sm:gap-3 lg:gap-4">
                {[
                  ...
                  <div key={i} className="bg-gold/5 dark:bg-gold/5 rounded-lg p-3 sm:p-4 border border-gold/15">
            ...
            <section className="bg-white dark:bg-gray-800 rounded-xl sm:rounded-2xl p-4 sm:p-6 lg:p-8 shadow-sm border border-gold/20 dark:border-gold/10">
              ...
              <div className="grid sm:grid-cols-2 gap-2 sm:gap-3 lg:gap-4">
                {[
                  ...
                  <div key={i} className="bg-gold/10 dark:bg-gold/5 rounded-lg sm:rounded-xl p-3 sm:p-4 border border-gold/20">
              ...
              <p className="text-sm sm:text-base text-gray-700 dark:text-gray-300 mt-4 sm:mt-6">
                For detailed information, see our <a href="/cookie-policy" className="text-green hover:text-green/70 dark:text-green/80 font-medium underline min-h-[44px] inline-flex items-center">Cookie Policy</a>.
              </p>
            </section>
                  ...
                  <div className="grid sm:grid-cols-2 gap-2 sm:gap-3">
                    {[
                      ...
                      <a key={i} href={link.url} target="_blank" rel="noopener noreferrer"
                        className="flex items-center gap-2 bg-gold/5 dark:bg-gold/5 rounded-lg p-2 sm:p-3 text-green dark:text-green/80 hover:bg-gold/10 dark:hover:bg-gold/10 transition-colors min-h-[44px] border border-gold/15">
            ...
            <section className="bg-white dark:bg-gray-800 rounded-xl sm:rounded-2xl p-4 sm:p-6 lg:p-8 shadow-sm border border-gold/20 dark:border-gold/10">
              <div className="flex items-center gap-2 sm:gap-3 mb-4 sm:mb-6">
                <div className="w-8 h-8 sm:w-10 sm:h-10 rounded-lg bg-green/10 dark:bg-green/20 flex items-center justify-center flex-shrink-0">
                  <Globe className="w-4 h-4 sm:w-5 sm:h-5 text-green dark:text-green/80" />
                </div>
              ...
              <div className="grid gap-2 sm:gap-3 lg:gap-4">
                {[
                  ...
                  <div key={i} className="flex flex-col sm:flex-row sm:items-center sm:justify-between bg-gold/5 dark:bg-gold/5 rounded-lg p-3 sm:p-4 gap-2 sm:gap-0 border border-gold/15">
                    <div>
                    ...
                    {service.url && (
                      <a href={service.url} target="_blank" rel="noopener noreferrer"
                        className="text-green dark:text-green/80 hover:underline text-xs sm:text-sm flex items-center gap-1 min-h-[44px] sm:min-h-0">
              ...
              <div className="bg-green/10 dark:bg-green/10 rounded-lg sm:rounded-xl p-3 sm:p-4 mt-4 sm:mt-6 border border-green/20">
                <p className="text-sm sm:text-base text-green dark:text-green/80 font-medium">
            ...
            <section className="bg-white dark:bg-gray-800 rounded-xl sm:rounded-2xl p-4 sm:p-6 lg:p-8 shadow-sm border border-gold/20 dark:border-gold/10">
              <div className="flex items-center gap-2 sm:gap-3 mb-4 sm:mb-6">
                <div className="w-8 h-8 sm:w-10 sm:h-10 rounded-lg bg-green/10 dark:bg-green/20 flex items-center justify-center flex-shrink-0">
                  <Shield className="w-4 h-4 sm:w-5 sm:h-5 text-green dark:text-green/80" />
                </div>
              ...
              <div className="grid sm:grid-cols-2 gap-2 sm:gap-3 lg:gap-4">
                {[
                  ...
                  <div key={i} className="bg-green/5 dark:bg-green/5 rounded-lg p-3 sm:p-4 border border-green/15">
            ...
            <section className="bg-white dark:bg-gray-800 rounded-xl sm:rounded-2xl p-4 sm:p-6 lg:p-8 shadow-sm border border-gold/20 dark:border-gold/10">
              ...
              <div className="overflow-x-auto rounded-lg sm:rounded-xl border border-gold/20 dark:border-gold/10">
                <table className="w-full min-w-[300px]">
                  <thead className="bg-gold/10 dark:bg-gold/5">
                    <tr>
            ...
            <section className="bg-white dark:bg-gray-800 rounded-xl sm:rounded-2xl p-4 sm:p-6 lg:p-8 shadow-sm border border-gold/20 dark:border-gold/10">
              <div className="flex items-center gap-2 sm:gap-3 mb-4 sm:mb-6">
                <div className="w-8 h-8 sm:w-10 sm:h-10 rounded-lg bg-green/10 dark:bg-green/20 flex items-center justify-center flex-shrink-0">
                  <Lock className="w-4 h-4 sm:w-5 sm:h-5 text-green dark:text-green/80" />
                </div>
              ...
              <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 gap-2 sm:gap-3 lg:gap-4">
                {[
                  ...
                  <div key={i} className="bg-green/5 dark:bg-green/5 rounded-lg sm:rounded-xl p-2 sm:p-3 lg:p-4 text-center border border-green/15">
            ...
            <section className="bg-white dark:bg-gray-800 rounded-xl sm:rounded-2xl p-4 sm:p-6 lg:p-8 shadow-sm border border-gold/20 dark:border-gold/10">
              <div className="flex items-center gap-2 sm:gap-3 mb-4 sm:mb-6">
                <div className="w-8 h-8 sm:w-10 sm:h-10 rounded-lg bg-green/10 dark:bg-green/20 flex items-center justify-center flex-shrink-0">
                  <Heart className="w-4 h-4 sm:w-5 sm:h-5 text-green dark:text-green/80" />
                </div>
                <h2 className="text-lg sm:text-xl lg:text-2xl font-bold text-gray-900 dark:text-white">12. Health Information Disclaimer</h2>
              </div>
              <div className="bg-green/5 dark:bg-green/5 border-l-4 border-green p-3 sm:p-4 lg:p-6 rounded-r-lg">
                <p className="text-sm sm:text-base lg:text-lg text-green dark:text-green/80 leading-relaxed">
            ...
            <section className="bg-white dark:bg-gray-800 rounded-xl sm:rounded-2xl p-4 sm:p-6 lg:p-8 shadow-sm border border-gold/20 dark:border-gold/10">
              <div className="flex items-center gap-2 sm:gap-3 mb-4 sm:mb-6">
                <div className="w-8 h-8 sm:w-10 sm:h-10 rounded-lg bg-green/10 dark:bg-green/20 flex items-center justify-center flex-shrink-0">
                  <Baby className="w-4 h-4 sm:w-5 sm:h-5 text-green dark:text-green/80" />
                </div>
              ...
              <div className="bg-green/5 dark:bg-green/5 border-l-4 border-green p-4 sm:p-6 rounded-r-lg">
                <div className="flex items-start gap-3">
                  <AlertTriangle className="w-5 h-5 sm:w-6 sm:h-6 text-green dark:text-green/80 flex-shrink-0 mt-0.5" />
                  <div>
                    <p className="text-sm sm:text-base font-semibold text-green dark:text-green/80 mb-2">
                ...
                <div className="space-y-3">
                  {[
                    ...
                    <div key={i} className="flex items-start gap-3 bg-white dark:bg-gray-800 rounded-lg p-3 sm:p-4 border border-gold/10">
                      <div className="w-8 h-8 rounded-full bg-green text-white flex items-center justify-center font-bold text-sm flex-shrink-0">{item.num}</div>
                      <div>
            ...
            <section className="bg-white dark:bg-gray-800 rounded-xl sm:rounded-2xl p-4 sm:p-6 lg:p-8 shadow-sm border border-gold/20 dark:border-gold/10">
              <div className="flex items-center gap-2 sm:gap-3 mb-4 sm:mb-6">
                <div className="w-8 h-8 sm:w-10 sm:h-10 rounded-lg bg-green/10 dark:bg-green/20 flex items-center justify-center flex-shrink-0">
                  <FileCheck className="w-4 h-4 sm:w-5 sm:h-5 text-green dark:text-green/80" />
                </div>
                <h2 className="text-lg sm:text-xl lg:text-2xl font-bold text-gray-900 dark:text-white">19. Agreeing to Terms</h2>
              </div>
              <div className="bg-green/5 dark:bg-green/5 border-l-4 border-green p-4 sm:p-6 rounded-r-lg mb-4 sm:mb-6">
                <p className="text-sm sm:text-base lg:text-lg text-green dark:text-green/80 font-medium">
            ...
            <div className="sticky top-24 space-y-4 sm:space-y-6">
              ...
              <div className="bg-white dark:bg-gray-800 rounded-xl sm:rounded-2xl p-4 sm:p-6 shadow-sm border border-gold/20 dark:border-gold/10">
                <div className="flex items-center gap-2 mb-3 sm:mb-4">
                  <Type className="w-4 h-4 sm:w-5 sm:h-5 text-green dark:text-green/80" />
                  ...
                  {textSizeOptions.map((size) => (
                    <button
                      ...
                      className={`px-3 py-2 rounded-lg text-xs sm:text-sm font-medium transition-all duration-200 min-h-[44px] ${textSize === size.id
                          ...
                          : 'bg-gold/10 dark:bg-gold/5 text-gray-700 dark:text-gray-300 hover:bg-green/10 dark:hover:bg-green/10'
                        }`}
                    >
                      {size.label}
                    </button>
